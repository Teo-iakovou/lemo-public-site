...
export const messages = {
  el: {
    ...
    booking: {
      ...
      second: {
        add: "Προσθήκη δεύτερου ραντεβού την ίδια ημέρα (προαιρετικό)",
        remove: "Αφαίρεση δεύτερου ραντεβού",
        title: "Δεύτερο ραντεβού (ίδια ημέρα)",
        sameDayNote: "Ίδια ημέρα με το πρώτο:",
        forSomeoneElse: "Είναι για άλλο άτομο",
        theirName: "Όνομα ατόμου",
        pickBarber: "Κουρέας",
        pickTime: "Ώρα",
      ...
      labels: {
        ...
        slotUnavailable: "Η ώρα που είχατε επιλέξει δεν είναι πλέον διαθέσιμη. Επιλέξτε άλλη.",
    ...
    profile: {
      ...
      messages: {
        ...
        siblingNotice: "Το άλλο σας ραντεβού ΠΑΡΑΜΕΝΕΙ κλεισμένο:",
        siblingFor: "για",
      },
      actions: {
        cancelAppointment: "Ακύρωση ραντεβού",
        changeAppointment: "Αλλαγή ραντεβού",
      },
      errors: {
    ...
    home: {
      ...
      meetTeam: "Γνώρισε την ομάδα μας",
    ...
    team: {
      ...
      ariaToggle: "Δείτε λεπτομέρειες για {name}",
      members: {
        lemo: {
          name: "LEMO",
          displayName: "Lemo",
          realName: "Michalis Lemoniatis",
          role: "Ιδρυτής",
        },
        forou: {
          name: "FOROU",
          displayName: "Forou",
          realName: "Antreas Christoforou",
          role: "Barber",
        },
        koushis: {
          name: "KOUSHIS",
  ...
  en: {
    ...
    booking: {
      ...
      second: {
        add: "Add a second appointment the same day (optional)",
        remove: "Remove second appointment",
        title: "Second appointment (same day)",
        sameDayNote: "Same day as the first:",
        forSomeoneElse: "This one is for someone else",
      ...
      labels: {
        ...
        slotUnavailable: "The time you selected is no longer available. Please pick another.",
    ...
    profile: {
      ...
      messages: {
        ...
        siblingNotice: "Your other appointment STAYS booked:",
        siblingFor: "for",
      },
      actions: {
    ...
    team: {
      ...
      ariaToggle: "Show details for {name}",
      members: {
        lemo: {
          name: "LEMO",
          displayName: "Lemo",
